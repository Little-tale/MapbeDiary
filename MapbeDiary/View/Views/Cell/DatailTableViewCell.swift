...
final class DatailTableViewCell: BaseTableViewCell {
    ...
    override func configureLayout() {
        detailContents.snp.makeConstraints { make in
            ...
            make.trailing.equalTo(regDateLabel.snp.leading).inset( -4 )
            make.top.equalTo(contentView.safeAreaLayoutGuide).offset(10)
            make.height.greaterThanOrEqualTo(90).priority(.low)
        }
        infoButton.snp.makeConstraints { make in
            make.trailing.equalTo(contentView.safeAreaLayoutGuide).inset(12)
            make.top.equalTo(detailContents.snp.top)
            make.bottom.equalTo(regDateLabel.snp.top).inset( -6 )
        ...
        detailcollectionView.snp.makeConstraints {  make in
            make.top.equalTo(detailContents.snp.bottom).offset(10)
    ...
    override func designView() {
        settingButton()
        detailContents.numberOfLines = 2
